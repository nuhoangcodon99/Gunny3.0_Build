...
if(user_info.status == true){
		...
		document.write("<li><span style='float:left'>Bazooka</span><a class='server_enter' href='http://s1.ddt.hithere.com'></a></li>");
		document.write("</ul>");
		document.write("<p class='l-f-b'><a href='http://www.hithere.com/my/editprofile.php'>Edit Profile</a><a id='loginout1' href='http://www.hithere.com/login.php?do=Logout&_url=http://ddt.hithere.com/index.html'>Logout</a></p>");
		document.write("</div>");
		document.write("</div>");
}
else{
document.write("<div id='con_one_1'>");
document.write("<form method='post' action='http://www.hithere.com/login.php?do=Login&_url=http://ddt.hithere.com/index.html'>");
...
document.write("<div class='signBottom'><a target='_blank' href='http://www.hithere.com/my/forgot.php'>Forgot Password?</a>");
document.write("<a  href='http://in.ddt.hithere.com/in1.html?f=934000101'><img src='http://ddt.hithere.com/public/images/sign_up.png' /></a></div>");
document.write("</form>");
document.write("</div>");						
}
