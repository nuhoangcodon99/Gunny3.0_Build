<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddItem.aspx.cs"
    Inherits="WebApplication1.Admin.AddItem" %>
        ...
        <asp:Panel ID="SearchPanel" runat="server">
            <div class="formPanel">
                <fieldset>
                    ...
                    <p>
                        <asp:Label ID="Label1" runat="server" Text="Tên nhân vật" AssociatedControlID="UserName_tbx">
                        </asp:Label>
                        <asp:TextBox ID="UserName_tbx" runat="server" CssClass="textEntry"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                            ControlToValidate="UserName_tbx" ErrorMessage="RequiredFieldValidator">
                        </asp:RequiredFieldValidator>
                    </p>
                    <p>
                        <asp:Label ID="Label2" runat="server" Text="Item Template Id"
                            AssociatedControlID="Template_tbx"></asp:Label>
                        <asp:TextBox ID="Template_tbx" runat="server" CssClass="textEntry"></asp:TextBox>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/iditem.txt"></asp:HyperLink>
                        <a href="http://192.168.0.105/admingunny/iditem.txt" target="_blank">Link danh sách Item!</a>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                            ControlToValidate="UserName_tbx" ErrorMessage="RequiredFieldValidator">
                        </asp:RequiredFieldValidator>
                    </p>
                    <p>
                        <asp:Label ID="Label3" runat="server" Text="Cấp cường hóa" AssociatedControlID="Level_tbx">
                        </asp:Label>
                    ...
                    <p>
                        <asp:Label ID="Label4" runat="server" Text="Tấn công" AssociatedControlID="Attack_tbx">
                        </asp:Label>
                    ...
                    <p>
                        <asp:Label ID="Label5" runat="server" Text="Phòng thủ" AssociatedControlID="Defence_tbx">
                        </asp:Label>
                    ...
                    <p>
                        <asp:Label ID="Label6" runat="server" Text="Nhanh nhẹn" AssociatedControlID="Agility_tbx">
                        </asp:Label>
